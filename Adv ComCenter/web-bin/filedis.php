...
print ("<A HREF=\"filedis.php?update=$file\" style=\"text-decoration: none\"><B>$file</B></A> ($filesize Kb)   <B>URL:</B> http://www.bowdenworks.net/AdvForums/ComCenter/$filepath<BR><BR>");
